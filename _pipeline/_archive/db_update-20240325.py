...
filterable_columns = ['Rundate', 'SampleID', 'Clinical Relevance', 'Disease Name'] #, , , '''Gene'  'Nucleotide [AAchange]', 
                ...
                html.Div([
                    html.Div([
                        ...
                        dash_table.DataTable(
                            ...
                            columns = [{"name": i, "id": i} for i in df.columns if i != "Variant Record"],
...
def register_callbacks(app):
    ...
    @app.callback(
        Output('upload-rekap-excel', 'children'),
        [Input('upload-rekap-excel', 'filename')],
        [State('upload-rekap-excel', 'contents')],
        allow_duplicate=True
    )
