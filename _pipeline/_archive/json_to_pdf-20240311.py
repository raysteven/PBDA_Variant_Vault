...
def json_to_pdf(report_df, runfolder, workdir):
    for i in report_df.index:
        ...
        number_of_test_plotted = 0
        for key, value in test_result.items():
            story.append(Paragraph(f"{value['test_name']} ({key})", styles['Heading3']))
            story.append(Paragraph(f"Measured Value: {value['measured_value']}", styles['Normal']))
            story.append(Paragraph(f"Result Interpretation: {value['result_interpretation']}", justified_paragraph))
            story.append(Spacer(1, 10))
            # Adding image
            image_path = os.path.join(sample_report_dir, f"{key}_graph.png")  # Adjust the path accordingly
            if os.path.exists(image_path):
                story.append(Image(image_path, width=369.765, height=90))  # Adjust width and height as needed #.4365
            else:
                story.append(Paragraph("Image not found", styles['Normal']))  # Placeholder if image not found


            story.append(Spacer(1, 12))

            number_of_test_plotted +=1

            if number_of_test_plotted in (2, 5, 8, 11, 14, 17, 20):
                story.append(PageBreak())
        story.append(PageBreak())
        # Title
        story.append(Paragraph("Interpretation at-A-Glance/Implied Conditions", styles['Heading2']))
        ...
        for key in test_result.keys():
            globals()[f'{key}_graph'] = os.path.join(sample_report_dir, f'{key}_graph.png')

        
        table1_data = [
            [Paragraph("<b>Histidine</b>", imageTitle_style), Paragraph("<b>Lysine</b>",imageTitle_style)],
            [Image(HIS_graph, width=228.25, height=55.825), Image(LYS_graph, width=228.25, height=55.825)],
            [Paragraph("<b>Phenylalanine</b>", imageTitle_style), Paragraph("<b>Methionine</b>",imageTitle_style)],
            [Image(PHE_graph, width=228.25, height=55.825), Image(MET_graph, width=228.25, height=55.825)],
            [Paragraph("<b>Arginine</b>", imageTitle_style), Paragraph("<b>Leucine</b>",imageTitle_style)],
            [Image(ARG_graph, width=228.25, height=55.825), Image(LEU_graph, width=228.25, height=55.825)],
            [Paragraph("<b>Isoleucine</b>", imageTitle_style), Paragraph("<b>Valine</b>",imageTitle_style)],
            [Image(ILE_graph, width=228.25, height=55.825), Image(VAL_graph, width=228.25, height=55.825)],
        ]
        ...
        table2_data = [
            [Paragraph("<b>Glutamic Acid</b>", imageTitle_style), Paragraph("<b>Cysteine</b>",imageTitle_style)],
            [Image(GLU_graph, width=228.25, height=55.825), Image(CYS_graph, width=228.25, height=55.825)],
            [Paragraph("<b>Glycine</b>", imageTitle_style), None],
            [Image(GLY_graph, width=228.25, height=55.825), None],
        ]
        ...
        story.append(Spacer(1, 12))        
        table3_data = [
            [Paragraph("<b>Threonine</b>", imageTitle_style), Paragraph("<b>Lysine</b>",imageTitle_style)],
            [Paragraph("Zinc (Zn) and Vitamin B6 supplementation", imageCaption_style), Paragraph("Iron (Fe), Vitamin B6, and Vitamin C supplementation ",imageCaption_style)],
            [Image(THR_graph, width=228.25, height=55.825), Image(LYS_graph, width=228.25, height=55.825)],
            
            [Paragraph("<b>Arginine</b>", imageTitle_style), Paragraph("<b>Methionine</b>",imageTitle_style)],
            [Paragraph("Manganese (Mn) supplementation", imageCaption_style), Paragraph("Magnesium (Mg) and Vitamin B6 supplementation",imageCaption_style)],
            [Image(ARG_graph, width=228.25, height=55.825), Image(MET_graph, width=228.25, height=55.825)],

            [Paragraph("<b>Valine</b>", imageTitle_style), Paragraph("<b>Leucine</b>",imageTitle_style)],
            [Paragraph("Vitamin B6 supplementation", imageCaption_style), Paragraph("Vitamin B6 supplementation",imageCaption_style)],
            [Image(VAL_graph, width=228.25, height=55.825), Image(LEU_graph, width=228.25, height=55.825)],

            [Paragraph("<b>Phenylalanine</b>", imageTitle_style), Paragraph("<b>Aspartic Acid</b>",imageTitle_style)],
            [Paragraph("Iron (Fe), Vitamin B1, and Vitamin C supplementation", imageCaption_style), Paragraph("Magnesium (Mg) and Zinc (Zn) supplementation",imageCaption_style)],
            [Image(PHE_graph, width=228.25, height=55.825), Image(ASP_graph, width=228.25, height=55.825)],

            [Paragraph("<b>Tryptophan</b>", imageTitle_style), Paragraph("<b>Glycine</b>",imageTitle_style)],
            [Paragraph("Vitamin B3 and Vitamin B6 supplementation", imageCaption_style), Paragraph("Folic Acid, Vitamin B5, Vitamin B6 supplementation",imageCaption_style)],
            [Image(TRP_graph, width=228.25, height=55.825), Image(GLY_graph, width=228.25, height=55.825)],
        ]
        ...
        story.append(PageBreak())
        table4_data = [
            [Paragraph("<b>Cystine</b>", imageTitle_style), Paragraph("<b>Proline</b>",imageTitle_style)],
            [Paragraph("Copper (Cu) and Vitamin B2 supplementation", imageCaption_style), Paragraph("Vitamin B3 and Vitamin C supplementation",imageCaption_style)],
            [Image(CYS_graph, width=228.25, height=55.825), Image(PRO_graph, width=228.25, height=55.825)],

            [Paragraph("<b>Tyrosine</b>", imageTitle_style), Paragraph("<b>Glutamine</b>",imageTitle_style)],
            [Paragraph("Copper (Cu), Vitamin C, and Vitamin B6 supplementation", imageCaption_style), Paragraph("Vitamin B6 supplementation",imageCaption_style)],
            [Image(TYR_graph, width=228.25, height=55.825), Image(GLN_graph, width=228.25, height=55.825)],            

            [Paragraph("<b>Glutamic Acid</b>", imageTitle_style), None],
            [Paragraph("Vitamin B6 and Vitamin B3 supplementation", imageCaption_style), None],
            [Image(GLU_graph, width=228.25, height=55.825), None], 
        ]
        ...
        story.append(Spacer(1, 12))
        table5_data = [
            [Paragraph("<b>Phenylalanine</b>", imageTitle_style), Paragraph("<b>Tryptophan</b>",imageTitle_style)],
            [Image(PHE_graph, width=228.25, height=55.825), Image(TRP_graph, width=228.25, height=55.825)],
        ]        
        table5 = Table(table5_data)
        table5.setStyle([
            ('VALIGN', (0, 0), (-1, -1), 'TOP'),  # Align images at the top of the cells
            ('ALIGN', (0, 0), (-1, -1), 'LEFT'),  # Align images to the left
        ])
        ...
        story.append(Spacer(1, 12))
        table6_data = [
            [Paragraph("<b>Leucine</b>", imageTitle_style), Paragraph("<b>Isoleucine</b>",imageTitle_style)],
            [Image(LEU_graph, width=228.25, height=55.825), Image(ILE_graph, width=228.25, height=55.825)],
            [Paragraph("<b>Valine</b>", imageTitle_style), Paragraph("<b>Phenylalanine</b>",imageTitle_style)],
            [Image(VAL_graph, width=228.25, height=55.825), Image(PHE_graph, width=228.25, height=55.825)],
            [Paragraph("<b>Tyrosine</b>", imageTitle_style), Paragraph("<b>Tryptophan</b>",imageTitle_style)],
            [Image(TYR_graph, width=228.25, height=55.825), Image(TRP_graph, width=228.25, height=55.825)],
            [Paragraph("<b>Glycine</b>", imageTitle_style), None],
            [Image(GLY_graph, width=228.25, height=55.825), None],
        ]        
        table6 = Table(table6_data)
        table6.setStyle([
            ('VALIGN', (0, 0), (-1, -1), 'TOP'),  # Align images at the top of the cells
            ('ALIGN', (0, 0), (-1, -1), 'LEFT'),  # Align images to the left
        ])
